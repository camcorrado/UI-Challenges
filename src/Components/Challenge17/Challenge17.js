...
export default class Challenge17 extends Component {
    ...
    if (time.getHours() <= 6 || time.getHours() >= 20) {
      this.setState({
        ...
        background: {
          ...
          backgroundImage: "url('https://i.imgur.com/GcCBOp4.jpg')",
        },
      });
    } else {
      this.setState({
        ...
        background: {
          ...
          backgroundImage: "url('https://i.imgur.com/OkEcsWK.jpg')",
        },
      });
    }
  }
  ...
  render() {
    ...
    const { backgroundColor, backgroundImage } = this.state.background;
    return (
      <section className="homeMonitoringDashboard">
            ...
            >
              ...
              >
                ...
                <FontAwesomeIcon
                  ...
                  className="faIcon"
                  style={{ color: frontDoor ? "green" : "red" }}
                />
              </div>
              <div
                className="alarmOption"
              ...
              >
                ...
                <FontAwesomeIcon
                  ...
                  className="faIcon"
                  style={{ color: backDoor ? "green" : "red" }}
                />
              </div>
            </div>
